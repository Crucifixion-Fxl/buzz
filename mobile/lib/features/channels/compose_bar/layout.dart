  ...
  Widget _buildBar(BuildContext context) {
    ...
    final content = Column(
      ...
      children: [
        ...
        // Keep the compact surface out of the native focus system. In
        // particular, Android must not restore focus to an underlying channel
        // composer after a focused thread route is popped.
        if (isExpanded)
          TextField(
